...
let addOrderItemsForm = document.getElementById('add-orderitems-form');
...
addOrderItemsForm.addEventListener("submit", function (e) {
    ...
    let inputInventoryID = document.getElementById("input-inventoryID");
    let inputVinylQty = document.getElementById("input-vinylQty");
   

    // Get the values from the form fields
    let orderIDValue = inputOrderID.value;
    let inventoryIDValue = inputInventoryID.value;
    let vinylQtyValue = inputVinylQty.value;

    // Put our data we want to send in a javascript object
    let data = {
        orderID: orderIDValue,
        inventoryID: inventoryIDValue,
        vinylQty: vinylQtyValue
    }
